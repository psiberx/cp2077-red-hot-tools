...
- Cyberpunk 2077 2.21
- [ArchiveXL](https://github.com/psiberx/cp2077-archive-xl) 1.21.0+
...
3. _(Optional)_ Install CET UI: Extract the archive `RedHotTools-x.x.x-Overlay.zip` into the Cyberpunk 2077 directory.
